...
vec4 calcDirLight(vec4 diffuse, vec4 specular, DirectionalLight light, vec3 position, vec3 normal) {
...
void main() {
    ...
    vec4 diffuseSpecularComp = calcDirLight(diffuse, specular, directionalLight, outPosition, outNormal);
